...
class PayrollTab(ttk.Frame):
    ...
    def _build_ui(self):
        ...
        self.from_entry = DateEntry(top, width=10, date_pattern="dd-mm-yyyy")
        self.from_entry.grid(row=0, column=3, padx=4)

        ttk.Label(top, text="To").grid(row=0, column=4, padx=4)
        self.to_entry = DateEntry(top, width=10, date_pattern="dd-mm-yyyy")
        ...
        self.tree.column("date", stretch=True, minwidth=200)
        self.tree.column("day", stretch=True, minwidth=160)
        self.tree.column("hours", stretch=True, minwidth=120)
    ...
    def _generate_period(self):
        ...
        while cur <= end:
            ...
            self.tree.insert(
                "", "end",
                values=(cur.strftime("%d-%m-%Y"), cur.strftime("%A"), hours)
            )
    ...
    def _edit_hours(self, event):
        ...
        spin = ttk.Spinbox(self.tree, from_=0, to=24, increment=0.5)
